            ...
            <main>
                ...
                <div class="container mx-auto py-4">
                    <div class = "bg-white rounded-lg shadow-lg my-2 pb-2 pt-2 mx-auto px-4 justify-center md:px-8">
                        ...
                        Please feel free to interact with it either on the device itself or on your own devices at: <a href="https://tinyurl.com/bpswan">tinyurl.com/bpswan</a>
                        <br>
                        It is also appreciated if you can please fill out a short (5-10 minutes) survey on the bulletin board as well at: <a href="https://forms.gle/dp3FW7XsG4DQwh7R9">   
                        https://forms.gle/dp3FW7XsG4DQwh7R9</a>.
                    </div>
                    @yield('content')
                </div>
            </main>
